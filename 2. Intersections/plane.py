...
class Plane(object):
    ...
    def __repr__(self):
        ...
        return 'Plane(normal_vector = Vector(' + str([round(float(value), 3) for value in  self.normal_vector.coordinates]) + '), constant_term = ' + str(round(float(self.constant_term), 3)) +')'
