...
class Line(object):
    ...
    def __repr__(self):
        ...
        return 'Line(normal_vector = Vector(' + str([value for value in  self.normal_vector.coordinates]) + '), constant_term = ' + str(self.constant_term) +')'
...
##            print(A*D - B*C)
            return Vector(Vector([x_numerator, y_numerator]).scalar_mult(one_over_denom))
